...
class ImageViewer(QtGui.QListView):
    ...
    def showSingleImage(self, selectedIndex):
        ...
        self.tableView.setItem(0, 0, QTableWidgetItem('Date added:'))
        self.tableView.setItem(1, 0, QTableWidgetItem('Image index:'))
        self.tableView.setItem(2, 0, QTableWidgetItem('Source laboratory:'))
        self.tableView.setItem(3, 0, QTableWidgetItem('Diagnosis:'))
        self.tableView.setItem(4, 0, QTableWidgetItem('Host species:'))
        self.tableView.setItem(5, 0, QTableWidgetItem('Parasite strain:'))
        self.tableView.setItem(6, 0, QTableWidgetItem('Parasitic count:'))
        self.tableView.setItem(7, 0, QTableWidgetItem('Zoom:'))
        self.tableView.setItem(8, 0, QTableWidgetItem('Additional Slide ID:'))
        self.tableView.setItem(9, 0, QTableWidgetItem('Other comments:'))
